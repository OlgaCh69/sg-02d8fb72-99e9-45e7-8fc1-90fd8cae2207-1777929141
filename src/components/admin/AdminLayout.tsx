...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navItems = [
    ...
    { href: "/admin/live-chat", icon: MessageSquare, label: "Live Chat" },
    ...
    { href: "/admin/prompt-tuning", icon: Wand2, label: "Prompt Tuning" },
    { href: "/admin/playbooks", icon: BookCheck, label: "Playbooks" },
    { href: "/admin/ab-tests", icon: FlaskConical, label: "A/B Tests" },
